...
Now you should see the live departures of all public transport running from station Landungsbrücken in Hamburg, Germany, which you can - and should - change later on, of course.
